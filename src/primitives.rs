...
impl<'de> BorrowDecode<'de> for PublicKey {
    fn borrow_decode<D:bincode::de::Decoder>(
        decoder: &mut D,
    ) -> core::result::Result<Self,bincode::error::DecodeError> {
        let pk_bytes: [u8; schnorrkel_purplecoin::PUBLIC_KEY_LENGTH] =bincode::Decode::decode(decoder)?;
...
impl Decode for Signature {
    fn decode<D:bincode::de::Decoder>(
        ...
        let pk_bytes: [u8; schnorrkel_purplecoin::SIGNATURE_LENGTH] =bincode::Decode::decode(decoder)?;
